...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
  ...
  <body>
      ...
      <div class="azad_separator"></div>
      <div class="azad_help" id="azad_help">
          <a href="https://github.com/philipmulcahy/azad/blob/master/README.md" target="_blank" class="azad_help" id="azad_help">CLICK HERE if you get incorrect results!</a>
      </div>
      <div id="azad_settings">
          <input type="checkbox" id="show_totals_in_csv" value="show_totals_in_csv" v-model="checked_settings">
          <label for="show_totals_in_csv">Include totals row in csv/spreadsheet downloads</label>
      </div>
      <div class="azad_separator"></div>
      <div id="footer">
